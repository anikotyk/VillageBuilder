...
public class TutorialHintView : MonoBehaviour
{
    ...
    private void OnTutorialStepEntered(TutorialStep step)
    {
    ...
    private void OnTutorialStepExited(TutorialStep step)
    {
        step.Event.ProgressChanged -= OnProgressChanged;
        step.Entered -= OnTutorialStepEntered;
        step.Exited -= OnTutorialStepExited;
