...
public class ResourceEarnView : MonoBehaviour
{
    ...
    private TimerDelay _fadeOutTimerDelay;
    ...
    {
        _fadeOutTimerDelay?.Kill();
        _fadeTweener?.Kill();
        _fadeOutTimerDelay = _timer.ExecuteWithDelay(FadeOut, _fadeOutDelay);
    ...
    {
        _fadeTweener = _canvasGroup.DOFade(0, _fadeDuration).OnComplete(() => _currentEarned = 0);
    }
}
