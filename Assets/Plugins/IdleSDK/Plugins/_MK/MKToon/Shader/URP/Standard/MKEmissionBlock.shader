...
Shader "MK/Toon/URP/Standard/PropertyBlock"
{
	Properties
	{
		/////////////////
		...
		[PerRendererData] _EmissionColor ("", Color) = (0, 0, 0, 1)
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local __ _MK_EMISSION
			#pragma shader_feature_local __ _MK_EMISSION_MAP
